...
<div class="main-div">
    <form action="<?php echo U('Admin/cat/categoryEdit');?>" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                <td class="label">分类名称:</td>
                <td>
                    <input type='text' name='cname' maxlength="20" value="<?php echo ($cat_info['cname']); ?>" size='27' /><font color="red">*</font>
                </td>
            </tr>
            <tr>
