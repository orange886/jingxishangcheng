    ...
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php if(is_array($catInfo)): foreach($catInfo as $key=>$info): ?><tr align="center" class="0">
                ...
                <img src="/Public/Admin/Imagesmenu_minus.gif" width="9" height="9" border="0" style="margin-left:0em" />
                ...
                <a href="#">编辑</a> |
                <a href="<?php echo U('Admin/cat/categorydel',array('parent_id'=>$info['parent_id']));?>" title="移除" onclick="">移除</a>
                </td>
