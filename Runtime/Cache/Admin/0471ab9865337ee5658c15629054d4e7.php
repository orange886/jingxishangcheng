...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="/Public/Admin/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				...
				<dl>
					...
					<dd>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="/Public/Admin/images/view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="/Public/Admin/images/view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="/Public/Admin/images/view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Admin/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Admin/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Admin/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Admin/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/Public/Admin/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<dl>
						<dt><a href=""><img src="/Public/Admin/images/hpG4.jpg" alt="" /></a></dt>
						<dd><a href="">惠普G4-1332TX 14英寸笔记...</a></dd>
					</dl>

					<dl class="last">
						<dt><a href=""><img src="/Public/Admin/images/crazy4.jpg" alt="" /></a></dt>
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m1.jpg',largeimage: '/Public/Admin/images/preview_l1.jpg'}"><img src="/Public/Admin/images/preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m2.jpg',largeimage: '/Public/Admin/images/preview_l2.jpg'}"><img src="/Public/Admin/images/preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m3.jpg',largeimage: '/Public/Admin/images/preview_l3.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m4.jpg',largeimage: '/Public/Admin/images/preview_l4.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m5.jpg',largeimage: '/Public/Admin/images/preview_l5.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m6.jpg',largeimage: '/Public/Admin/images/preview_l6.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m7.jpg',largeimage: '/Public/Admin/images/preview_l7.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m8.jpg',largeimage: '/Public/Admin/images/preview_l8.jpg'}">  
	    							<img src="/Public/Admin/images/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Admin/images/preview_m9.jpg',largeimage: '/Public/Admin/images/preview_l9.jpg'}">  
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="/Public/Admin/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="/Public/Admin/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/Admin/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/Admin/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/Admin/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
	...
	<div class="footer w1210 bc mt10">
		...
		<p class="auth">
			<a href=""><img src="/Public/Admin/images/xin.png" alt="" /></a>
			<a href=""><img src="/Public/Admin/images/kexin.jpg" alt="" /></a>
			<a href=""><img src="/Public/Admin/images/police.jpg" alt="" /></a>
			<a href=""><img src="/Public/Admin/images/beian.gif" alt="" /></a>
		</p>
	</div>
	<!-- 底部版权 end -->
