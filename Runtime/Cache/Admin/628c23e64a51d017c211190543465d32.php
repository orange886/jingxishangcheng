...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 查看新商品 </span>
...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="<?php echo U('Admin/goods/goodsEdit');?>" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="goods_sn" value="<?php echo ($goods_info['goods_sn']); ?>" size="20"/>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="goods_body" cols="40" rows="3"><?php echo ($goods_info['goods_body']); ?></textarea>
                    </td>
                </tr>
            </table>
            <input type="hidden" name="cate_id" value="<?php echo ($goods_info['cate_id']); ?>"/>
        </form>
    </div>
</div>
