		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					...
					<?php if(is_array($tree)): foreach($tree as $key=>$t): ?><div class="cat item1">

						<?php if($t['lev'] == 0): ?><h3><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$t['cat_id']));?>"><?php echo ($t['cname']); ?></a> <b></b></h3><?php endif; ?>


						<div class="cat_detail">

							<?php if(is_array($tree)): foreach($tree as $key=>$tt): ?><dl class="dl_1st">
								<?php if($t['cat_id'] == $tt['parent_id']): ?><dt><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$tt['cat_id']));?>"><?php echo ($tt['cname']); ?></a></dt><?php endif; ?>
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					...
					<?php if(is_array($is_hot)): foreach($is_hot as $key=>$hot): ?><ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo ($hot['goods_img']); ?>" alt="" /><?php echo ($hot['goods_img']); ?></a></dt>
								<dd><a href=""><?php echo ($hot['goods_name']); ?></a></dd>
				...
				<div class="recommend none">
					<?php if(is_array($is_rec)): foreach($is_rec as $key=>$rec): ?><ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo ($rec['goods_img']); ?>" alt="" /><?php echo ($rec['goods_img']); ?></a></dt>
								<dd><a href=""><?php echo ($rec['goods_name']); ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo ($rec['shop_price']); ?></strong></dd>
							</dl>
						</li>
					</ul><?php endforeach; endif; ?>
				</div>
				...
				<!-- 新品上架 start-->
				<div class="new none">
					<?php if(is_array($is_new)): foreach($is_new as $key=>$new): ?><ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo ($new['goods_img']); ?>" alt="" /><?php echo ($new['goods_img']); ?></a></dt>
								<dd><a href=""><?php echo ($new['goods_name']); ?></a></dd>
